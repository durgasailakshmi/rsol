...
$sql = "SELECT name,contactnumber FROM buyerinfo where location IN(select location from   userinfo1 where username='$username1' and password='$password1') and whichbuyer='PlasticBuyer'"; 
